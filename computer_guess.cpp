...
{ int low = 1;
      ...
      char response;
       std::cout<<"Think number between 1 to 100 and i will try to guess it in 7 or less guess"<<std::endl;
      do
      {
       std::cout<<"Is your number" <<" "<<guess<< "? y/n "<<std::endl;
       std::cin>>response;

       if (response == 'y')
       {
        std::cout<<"I guess your number!"<<std::endl;
        break;
       }

       else if (response == 'n')
       {
        std::cout<<"Is my guess too high or too low?"<<std::endl;
        std::cin>>response;
        if (response == 'h')
        {
         high = guess - 1;
